...
//    Pawn* p1=new Pawn[50];
    ...
    while(check)
    {
        if(turn==1)
        {
            ...
            cin>>s;
            int p=s[1]-'0';
            if(s[0]=='P'){if(p1[p-1].p.x==-1){cout<<"Player Already Dead\n";continue;}}
            else if(s[0]=='N'){if(n1[p-1].p.x==-1){cout<<"Player Already Dead\n";continue;}}
        ...
        else
        {
            ...
            cin>>s;
            int p=s[1]-'0';
            if(s[0]=='P'){if(p2[p-1].p.x==-1){cout<<"Player Already Dead\n";continue;}}
            else if(s[0]=='N'){if(n2[p-1].p.x==-1){cout<<"Player Already Dead\n";continue;}}
